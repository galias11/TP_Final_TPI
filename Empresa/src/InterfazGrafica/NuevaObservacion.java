...
/**
 * clase NuevaObservacion
 * Interfaz grafica para Agregar una nueva observacion.
 */
  ...
  extends javax.swing.JFrame implements InterfazNuevaObservacion
{
    ...
    /*
     * Getters agregados para eventual test de GUI.
     */
    

    public JButton getAgregarObs() {
        return agregarObs;
    }
        ...
        throws InterfazException
    {
        if(observacion.getText().isEmpty())
            throw new InterfazException("Observacion vacia.");
    ...
    private void inicializarComponentes(){
        ...
        jComboBox1.addItem(Observacion.TEMA_FECHAS);
        jComboBox1.addItem(Observacion.TEMA_INSUMOS);
        jComboBox1.addItem(Observacion.TEMA_OTROS);
    }
