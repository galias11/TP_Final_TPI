...
public class EmpresaTest {
    ...
    public void testEMP02A() {
        try {
            ...
            assertTrue("EMP02A: La lista de pedidos contiene el pedido especificado.", !fixture.getEmpresaTest()
                                                                                               .getPedidos()
                                                                                               .containsKey(5));
        }
    }
 ...
 1));
    ...
    public void testEMP02C() {
        ...
        try {
            fixture.getEmpresaTest().cancelarPedido(5, "motivo");
            assertTrue("EMP02C: El pedido no se ha cancelado.", fixture.getEmpresaTest()
                                                                       .getPedidos()
                                                                       .get(5)
                                                                       .getEstado() == Pedido.CANCELADO);
        } catch (EmpresaException e) {
    ...
    public void testEMP03A() {
        ...
        try {
            ...
            fail("Se esperaba un error de Exception");
        }
    ...
    public void testEMP03B() {
        ...
        try {
            fixture.getEmpresaTest().reservarMateriales(10);
            assertTrue("No se redujo el inventario correctamente", fixture.getEmpresaTest()
                                                                          .getInventario()
                                                                          .get(1)
                                                                          .getCantidad() == 250.0);
        } catch (EmpresaException e) {
